...
# return rects : This value is based on geometry  and is in a more compact form so we can later apply NMS.
# return confidences : The confidence values in this list correspond to each rectangle in rects
